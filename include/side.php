<div class="list-group mt-3 list-group-flush">
    <a href="index.php" class="list-group-item list-group-item-action text-white bg-transparent"><i class="bi bi-speedometer2"></i> Dashboard</a>
    <a href="manageProject.php" class="list-group-item list-group-item-action text-white bg-transparent"><i class="bi bi-window-stack"></i> Manage Projects</a>
